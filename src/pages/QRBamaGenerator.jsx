  ...
  const generateQR = async () => {
    ...
    try {
      ...
      img.onload = () => {
        ...
        const textMetrics = ctx.measureText("BĀMA");
        ...
        // Dibujar el texto "BĀMA"
        ctx.fillStyle = "#000000";
        ctx.fillText("BĀMA", canvas.width / 2, canvas.height / 2);
  ...
  return (
    <div className="qr-generator-page">
      <div className="container">
        ...
        <p className="subtitle">Con el sello "BĀMA" en el centro</p>
        ...
        {qrCodeUrl && (
          <div className="qr-section">
            <h2>Tu código QR con BĀMA</h2>
            <div className="qr-container">
              <img
                src={qrCodeUrl}
                alt="Código QR con BĀMA"
                className="qr-image"
              />
            </div>
