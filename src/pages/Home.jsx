      ...
      <div className="home-container">
        ...
        <div className="hero-section">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Eleva tu brillo con joyería única y conecta con tu audiencia a
              través de códigos QR personalizados
            </p>
          </div>
        </div>
        ...
        <div className="features-section">
          ...
          <div className="feature-card">
            ...
            <h3>LinkTree</h3>
            <p>
              Conecta con Delfia a través de Instagram, tienda online y WhatsApp
            </p>
